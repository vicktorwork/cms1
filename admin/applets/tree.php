...
//============================================================================//
	...
	if ($do == 'tree'){
        ...
        $toolmenu[] = array('icon'=>'arhive.gif', 'title'=>'Архив', 'link'=>'admin/index.php?view=arhive');
        ...
        $toolmenu[] = array('icon'=>'liststuff.gif', 'title'=>$_LANG['AD_FILES'], 'link'=>'?view=components&do=config&link=files');
        $toolmenu[] = array('icon'=>'folders.gif', 'title'=>"Альбомы (фотогаллерея)", 'link'=>'?view=components&do=config&link=photos');
