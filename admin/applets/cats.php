                   ...
                   <!--       <td style="padding-left:6px">
						  ...
						  <?php
								...
								$scan_dir = scandir($directory);
									if(is_dir($directory)) {   //проверяем наличие директории
										 //директория существует
										 echo '<select name="tpl">';
										 $scan_dir = scandir($directory);    //сканируем (получаем массив файлов)
										 array_shift($scan_dir); // удаляем из массива '.'
										 array_shift($scan_dir); // удаляем из массива '..' 
									...
									else echo '<input name="tpl" type="text" style="width:160px" value="'.@$mod["tpl"].'">';
								?>
                            </td>
                        </tr>
                      </tbody>
...
<!--------------------------------------------------------------------------------------------------->
	...
	<table id="phto_config" style="display:none;">
		<tr>
            ...
            <td width="120">
                <input type="text" size="5" value="100" id="img_small_w" name="img_small_w"> пикс.
            </td>
        </tr>
        <tr>
            <td><strong>Ширина большой копии:</strong></td>
            <td>
                <input type="text" size="5" value="400" id="img_big_w" name="img_big_w"> пикс.
            </td>
        </tr>
        <tr>
            <td><strong>Квадратные:</strong></td>
            <td>
                <input type="radio" checked="checked" value="1" name="img_sqr"> Да
                <input type="radio" value="0" name="img_sqr"> Нет
            </td>
        </tr>
       <!-- 
	   <tr>
