      ...
      <tr>
		...
		<div class="small_box">
		  <div class="small_title"><?php echo $_LANG['AD_ICMS_RAVE']; ?></div>
            <ul>
              <li><a href="http://www.cms.vadyus.com/"><strong><?php echo $_LANG['AD_ICMS_OFFICIAL']; ?></strong></a></li>
              <li><a href="http://www.cms.vadyus.com/wiki"><?php echo $_LANG['AD_ICMS_DOCUMENTATION']; ?></a></li>
              <li><a href="http://www.cms.vadyus.com/forum"><?php echo $_LANG['AD_ICMS_FORUM']; ?></a></li>
            </ul>
		</div>
		<div class="small_box">
            ...
            <div class="advert_billing"><a href="http://www.cms.vadyus.com/billing/about.html"><strong><?php echo $_LANG['AD_BILLING']; ?></strong></a> &mdash; <?php echo $_LANG['AD_GAIN']; ?></div>
            ...
            <div class="advert_inshop"><a href="http://www.cms.vadyus.com/blogs/InstantSoft/professionalnyi-magazin-dlja-vadyus.html"><strong>InstantShop</strong></a> &mdash; <?php echo $_LANG['AD_SHOP']; ?></div>
