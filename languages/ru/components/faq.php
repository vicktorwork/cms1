...
$_LANG['QUESTION_PREMODER']     ='Вопрос и ответ на него будут опубликованы после проверки администратором.';
$_LANG['ERR_CAPTCHA']           ='Неправильно указан код с картинки!';
$_LANG['ERR_QUESTION']          ='Ваш вопрос слишком короткий!';
$_LANG['SET_QUESTION']          ='Задать вопрос';
$_LANG['SET_QUESTION_TEXT']     ='Опишите вашу проблему. Вопрос будет опубликован вместе с ответом после того, как его проверит администратор.';
$_LANG['CONTACTS_TEXT']         ='Укажите свое имя и контакты, если хотите, чтобы с вами связались лично.';
