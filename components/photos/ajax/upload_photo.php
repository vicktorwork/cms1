...
if(isset($_SESSION['lang']) && $_SESSION['lang'] != 'ru') {
	$album = $inDB->getNsCategory_back($_SESSION['lang'] . '_photo_albums', cmsCore::request('album_id', 'int', 0));
}
else{
	$album = $inDB->getNsCategory_back('cms_photo_albums', cmsCore::request('album_id', 'int', 0));
}
...
if ($file) {
    ...
    $photo['id'] = $inPhoto->addPhoto_new($photo);
